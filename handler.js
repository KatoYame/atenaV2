          ...
          if (chat.welcome) {
            ...
            for (let user of participants) {
              ...
              try {
                ...
                let wel = `https://api.lolhuman.xyz/api/base/welcome?apikey=929b48b9aa5a91abed8526cd&img1=${pp}&img2=https://telegra.ph/file/c0744c7abd9dcb9574871.png&background=${ppbg}&username=${encodeURIComponent(this.getName(user))}&member=${encodeURIComponent(groupMetadata.participants.length)}&groupname=${encodeURIComponent(this.getName(jid))}`
                let lea = `https://api.lolhuman.xyz/api/base/leave?apikey=929b48b9aa5a91abed8526cd&img1=${pp}&img2=https://telegra.ph/file/c0744c7abd9dcb9574871.png&background=${ppbg}&username=${encodeURIComponent(this.getName(user))}&member=${encodeURIComponent(groupMetadata.participants.length)}&groupname=${encodeURIComponent(this.getName(jid))}`
